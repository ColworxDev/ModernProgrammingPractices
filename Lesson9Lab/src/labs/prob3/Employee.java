...
public class Employee {
	...
	public static void main(String[] args) {
		...
		System.out.println(list.stream().sorted(Comparator.comparing(Employee::getName).reversed().thenComparing(Employee::getSalary).reversed()).collect(Collectors.toList()));
	}
}
