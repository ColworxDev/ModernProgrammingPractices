...
public class LoginWindow extends JFrame implements LibWindow {
	...
	private void addLoginButtonListener(JButton butn) {
		butn.addActionListener(evt -> {
			...
			System.out.println("username = "+us + " , password = "+pass);
			// SystemController cont = new SystemController();
			try {
				LibrarySystem.INSTANCE.ci.login(us, pass);
				JOptionPane.showMessageDialog(this, "Logged in succesfully");
				LibrarySystem.INSTANCE.isLoggedIn = true;
				LibrarySystem.INSTANCE.initAfterLoggingin();
